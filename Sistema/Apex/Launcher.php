...
class Launcher
{
     ...
     */
    public function launch(DatainfoUserInterface $user, TaskCollection $tasks, Activity $activity, EffortType $effortType, string $instance, string $ajaxId, string $salt, string $protected, string $parsedOraWwvApp104Cookie): array
    {
        $itemsToSubmit = [
        ...
        foreach ($tasks as $task) {
            ...
            $parameters['p_json'] = json_encode($pJson);
